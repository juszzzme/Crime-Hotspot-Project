...
def init_database():
    ...
    with app.app_context():
        ...
        existing_user = User.query.filter_by(email='kmd.zaheer2006@gmail.com').first()
        if existing_user:
        ...
        admin_user = User(
            ...
            first_name='Zaheer',
            last_name='Khan',
            password='244343',  # This will be hashed automatically
            is_active=True,
            is_admin=True,
        ...
        try:
            ...
            print("\n📋 Demo Credentials:")
            print("Admin: kmd.zaheer2006@gmail.com / 244343")
